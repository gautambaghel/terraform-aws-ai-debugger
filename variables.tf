...
variable "workspace_prefix" {
  description = "HCP Terraform workspace name prefix that allowed to run the AI debugger"
  type        = string
  default     = ""
}

variable "ai_debugger_iam_roles" {
...
variable "cloudwatch_log_group_name" {
  description = "AI debugger CloudWatch log group name"
  type        = string
  default     = "/hashicorp/terraform/ai-debugger/"
}
