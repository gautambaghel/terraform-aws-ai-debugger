resource "awscc_bedrock_guardrail" "ai_debugger_fulfillment" {
...
resource "awscc_bedrock_guardrail_version" "ai_debugger_fulfillment" {
  guardrail_identifier = awscc_bedrock_guardrail.ai_debugger_fulfillment.guardrail_id
